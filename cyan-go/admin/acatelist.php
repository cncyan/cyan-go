...
$pagesize=2;
$rows=getrowbypage("cb_acate",$pagesize);
...
<link rel="stylesheet" href="css/admin.css">
            ...
            <div class="cont">
				...
				function editcate(id){
					window.location="editacate.php?id="+id;
					}
				function delcate(id){
					if(confirm("确定要删除吗？删除后不可恢复哦！")){
					  window.location="doarticle.php?act=delacate&id="+id;
					}
					}
                 function turnadd(){
					   window.location="addacate.php";
					   }
                </script>
</body>
</html>
